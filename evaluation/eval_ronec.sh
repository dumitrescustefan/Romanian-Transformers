...
python3 tools/train.py dataset-ronec/train.conllu dataset-ronec/dev.conllu 10 --save_path "$model_dir" --lang_model_name "$model" --device $device --fine_tune --epochs 10 --learning_rate 2e-5 --iterations "$iterations" --batch_size 16
